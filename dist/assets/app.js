...
var _axios = _interopRequireDefault(__webpack_require__(28));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var getUserInfo = function getUserInfo() {
  return _axios.default.get('https://randomuser.me/api/').then(function (response) {
...
var _dataLoaderHoC = _interopRequireDefault(__webpack_require__(27));
...
var getInfo = function getInfo() {
  var promises = [];
  promises.push((0, _api.getUserInfo)());
  promises.push((0, _api.getUserInfo)());
  promises.push((0, _api.getUserInfo)());
  promises.push((0, _api.getUserInfo)());
...
var _default = function _default(props) {
  var version = _react.default.version; // const initialData = getInfo() || {};
  ...
  }, "Some header"), _react.default.createElement(_dataLoaderHoC.default, {
...
function (_React$Component) {
  ...
  function ContentSection(props) {
    ...
    _this = _possibleConstructorReturn(this, (ContentSection.__proto__ || Object.getPrototypeOf(ContentSection)).call(this, props));
    _this.state = {
  ...
  _createClass(ContentSection, [{
    ...
    value: function render() {
      return _react.default.createElement(_react.Fragment, null, _react.default.createElement("h1", null, "My awesome application using React ", this.props.version, "!!!"), this.state.data && this.state.data.length && this.state.data.map(function (user) {
        return _react.default.createElement("div", null, _react.default.createElement("code", {
          style: {
            display: 'block',
            background: 'black',
            color: 'green',
...
function (_React$Component) {
  ...
  function Async(props) {
    ...
    _this = _possibleConstructorReturn(this, (Async.__proto__ || Object.getPrototypeOf(Async)).call(this, props));
    _this.state = {
      initialData: [],
      status: 'none',
      value: null
...
var DataLoaderHoC = function DataLoaderHoC(props) {
  ...
  var ExampleWithAsync = function ExampleWithAsync(props) {
    return _react.default.createElement(Async, {
      promise: prom,
      then: function then(val) {
